...
if __name__ == '__main__':
    ...
    model.val(data='tianchi.yaml', split='val', imgsz=1632, agnostic_nms=False, batch=16, device=0,conf=0.14, save_json = False, save_txt=False, save_conf=False, half=True)
  # best  1280  851  672
