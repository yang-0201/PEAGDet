...
def copy_and_rename_layers(
    source_path, target_path, output_path, source_start=11, source_end=22, target_insert_after=23
):
    # 加载权重文件
    ...
    (target_insert_after + 1) - source_start  # 计算命名偏移量
