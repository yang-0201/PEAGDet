...
if __name__ == '__main__':
    ...
    model.train( resume=False, data='yixian.yaml', imgsz=640, epochs=200, lr0=0.01, optimizer='SGD', multi_scale = False, batch=16, device=0, copy_paste=0, scale=0.5, name="train-exp1", exist_ok=True)
