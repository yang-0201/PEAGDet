...
class VerticalConcat(BaseMixTransform):
    ...
    This class implements a vertical image concatenation technique where two images are stacked vertically,
    and their corresponding labels (YOLO format) are combined accordingly.
