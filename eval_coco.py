...
def parse_args():  
    ...
    parser.add_argument('--ann', default=r"E:\BaiduNetdiskDownload\2\annotations/val_annotations.json", type=str, help='Path to ground truth annotation file (COCO format)')
    parser.add_argument('--pred', default="./output_path/pred.json",type=str, help='Path to predicted results file (COCO format)')
